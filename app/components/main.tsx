...
const Main = (): JSX.Element => {
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white min-h-screen">
      <section className="flex flex-col md:flex-row items-center justify-around gap-5">
