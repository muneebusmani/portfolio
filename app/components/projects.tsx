      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#1e293b] p-6 rounded-xl shadow-md hover:scale-[1.02] transition-transform">
          ...
          <p className="mt-2 text-gray-300">
            Built a dynamic CMS using Laravel 12 and Inertia.js. Includes media
            uploads, polymorphic relationships, and role-based access.
          </p>
        ...
        <div className="bg-[#1e293b] p-6 rounded-xl shadow-md hover:scale-[1.02] transition-transform">
          ...
          <p className="mt-2 text-gray-300">
            A frontend-first app for pet listings using React, TypeScript, and
            Tailwind. Integrates with a backend API for data.
          </p>
          <div className="flex gap-2 mt-3 text-sm text-gray-400">
            <span>React</span>
